...
public final class SearchSubscriptions extends AbstractBrainTreeConnector {
     ...
     *
     * @param subscriptionSearchRequest the subscription search request
     * @return the subscription search request object with the relevant values
     * set
     * @throws JSONException Thrown on JSON parsing error
     */
     ...
     * @throws JSONException  Thrown on JSON parsing error.
     * @throws ParseException Thrown on Date parsing error.
     */
