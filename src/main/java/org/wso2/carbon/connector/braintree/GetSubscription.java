...
/**
 * The Class BraintreeGetSubscription.
 *
 * @see https://www.braintreepayments.com/docs/java/subscriptions/details
 */
public final class GetSubscription extends AbstractBrainTreeConnector {
    ...
    public void connect(final MessageContext messageContext) {
        ...
        try {
            ...
            messageContext.setProperty(
                    Constants.RESULT,
                    new Gson().toJson(braintreeGateway.subscription().find(
                            (String) messageContext.getProperty(Constants.SUBSCRIPTIONID))));
