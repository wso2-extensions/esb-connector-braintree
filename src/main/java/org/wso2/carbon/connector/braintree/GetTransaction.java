...
/**
 * BraintreeGetTransaction - Get Transaction.
 *
 * @see https://www.braintreepayments.com/docs/java/transactions/details
 */
public final class GetTransaction extends AbstractBrainTreeConnector {
    ...
    public void connect(final MessageContext messageContext) {
        ...
        try {
            ...
            messageContext.setProperty(
                    Constants.RESULT,
                    new Gson().toJson(braintreeGateway.transaction().find(
