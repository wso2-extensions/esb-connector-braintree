...
/**
 * The Class BraintreeGetMerchantAccountDetails.
 *
 * @see https://www.braintreepayments.com/docs/java/merchant_accounts/details
 */
public final class GetMerchantAccountDetails extends AbstractBrainTreeConnector {
    ...
    public void connect(final MessageContext messageContext) {
        ...
        try {
            ...
            // get merchant account details & convert to JSON format
            messageContext.setProperty(
                    Constants.RESULT,
                    new Gson().toJson(braintreeGateway.merchantAccount().find(
