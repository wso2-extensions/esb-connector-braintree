...
/**
 * The Class BraintreeGetCreditCard.
 *
 * @see https://www.braintreepayments.com/docs/java/credit_cards/details
 */
public final class GetCreditCard extends AbstractBrainTreeConnector {
    ...
    public void connect(final MessageContext messageContext) {
        ...
        try {
            ...
            messageContext.setProperty(
                    Constants.RESULT,
                    new Gson().toJson(braintreeGateway.creditCard().find(
