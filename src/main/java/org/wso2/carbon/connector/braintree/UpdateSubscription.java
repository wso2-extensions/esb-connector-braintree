...
public final class UpdateSubscription extends AbstractBrainTreeConnector {
     ...
     * @param request                update request for subscription
     * @param existingSubscriptionId ID of the subscription to update
     ...
     *
     * @param request UpdateModificationRequest
     * @param jObject JSONObject to extract data from
     * @throws JSONException the json exception
     */
     ...
     *
     * @param request - AddModificationRequest
     * @param jObject - JSONObject to extract data from
     * @throws JSONException the json exception
     */
